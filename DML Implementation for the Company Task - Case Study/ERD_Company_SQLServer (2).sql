...
UPDATE DEPARTMENT SET manager_id = '444444444', hire_date = '2020-03-10' WHERE D_no = 4;
UPDATE DEPARTMENT SET manager_id = '555555555', hire_date = '2021-07-01' WHERE D_no = 5;
...
(5, 'Automation',      'West City',  'Lab 3',   4);
...
('555555555', 'Adam',    'M', '2015-08-19'),
('111111111', 'Hana',    'F', '2009-11-02');
GO
